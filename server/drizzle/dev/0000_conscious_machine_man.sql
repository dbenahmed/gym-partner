...
--> statement-breakpoint
CREATE TABLE "dev"."plans_exercises" (
	"id" serial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "dev"."sets_of_sessions_exercises" (
	"id" serial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "dev"."templates_exercises" (
	"id" serial PRIMARY KEY NOT NULL,
...
ALTER TABLE "dev"."templates_exercises" ADD CONSTRAINT "fk_template" FOREIGN KEY ("template_id") REFERENCES "dev"."templates"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "dev"."weights_logs" ADD CONSTRAINT "fk_user" FOREIGN KEY ("user_id") REFERENCES "dev"."users"("id") ON DELETE cascade ON UPDATE no action;