...
--> statement-breakpoint
CREATE TABLE "main"."plans_exercises" (
	"id" serial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "main"."sets_of_sessions_exercises" (
	"id" serial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "main"."templates_exercises" (
	"id" serial PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "main"."weights_logs" (
	"id" serial PRIMARY KEY NOT NULL,
	"user_id" integer NOT NULL,
	"weight" integer,
	"creationdate" timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
...
--> statement-breakpoint
ALTER TABLE "main"."collections" ADD CONSTRAINT "collections_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "main"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."foods" ADD CONSTRAINT "fk_created_by" FOREIGN KEY ("created_by") REFERENCES "main"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."meals_logs" ADD CONSTRAINT "fk_meal" FOREIGN KEY ("meal_id") REFERENCES "main"."foods"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."meals_logs" ADD CONSTRAINT "fk_user" FOREIGN KEY ("user_id") REFERENCES "main"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."plans" ADD CONSTRAINT "plans_collection_id_fkey" FOREIGN KEY ("collection_id") REFERENCES "main"."collections"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."plans_exercises" ADD CONSTRAINT "fk_exercise" FOREIGN KEY ("exercise_id") REFERENCES "main"."exercises"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."plans_exercises" ADD CONSTRAINT "fk_plan" FOREIGN KEY ("plan_id") REFERENCES "main"."plans"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."sessions" ADD CONSTRAINT "fk_plan" FOREIGN KEY ("plan_id") REFERENCES "main"."plans"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."sets_of_sessions_exercises" ADD CONSTRAINT "fk_session_exercise_id" FOREIGN KEY ("exercise_id") REFERENCES "main"."exercises"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."sets_of_sessions_exercises" ADD CONSTRAINT "fk_session_id" FOREIGN KEY ("session_id") REFERENCES "main"."sessions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."templates_exercises" ADD CONSTRAINT "fk_exercise" FOREIGN KEY ("exercise_id") REFERENCES "main"."exercises"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."templates_exercises" ADD CONSTRAINT "fk_template" FOREIGN KEY ("template_id") REFERENCES "main"."templates"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "main"."weights_logs" ADD CONSTRAINT "fk_user" FOREIGN KEY ("user_id") REFERENCES "main"."users"("id") ON DELETE cascade ON UPDATE no action;