import * as repo from '../repositories/workout-sessions.repository.js';
import verifyPlanCreatedByUser from "../controllers/functions/verifyPlanWasCreatedByUser.js";
...
export const getWorkoutSessionsService = async (userId: number, startTime: Date) => {
