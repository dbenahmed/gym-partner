...
export const exercises = mainSchema.table("exercises", {
...
export const foods = mainSchema.table("foods", {
	id: integer().primaryKey().notNull(),
...
export const mealsLogs = mainSchema.table("meals_logs", {
	id: integer().primaryKey().notNull(),
...
export const plans = mainSchema.table("plans", {
	id: integer().primaryKey().notNull(),
...
export const setsOfSessionsExercises = mainSchema.table("sets_of_sessions_exercises", {
	id: integer().primaryKey().notNull(),
...
/*export const sessionsExercises = mainSchema.table("sessions_exercises", {
	id: integer().primaryKey().notNull(),
	exerciseId: integer("exercise_id").notNull(),
	sessionId: integer("session_id").notNull(),
	creationdate: timestamp({ withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
...
export const collections = mainSchema.table("collections", {
	id: integer().primaryKey().notNull(),
	userId: integer("user_id").notNull(),
	title: varchar({ length: 100 }).notNull(),
	creationdate: timestamp({ withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
...
export const templatesExercises = mainSchema.table("templates_exercises", {
	id: integer().primaryKey().notNull(),
...
export const weightsLogs = mainSchema.table("weights_logs", {
	id: integer().primaryKey().notNull(),
	userId: integer("user_id").notNull(),
	weight: integer(),
	creationdate: timestamp({ withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
...
export const plansExercises = mainSchema.table("plans_exercises", {
	id: integer().primaryKey().notNull(),
...
export const templates = mainSchema.table("templates", {
	id: integer().primaryKey().notNull(),
	title: varchar({ length: 100 }).notNull(),
	creationdate: timestamp({ withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
	updationdate: timestamp({ withTimezone: true, mode: 'string' }).default(sql`CURRENT_TIMESTAMP`).notNull(),
