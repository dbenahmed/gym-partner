...
export const getAllFoodsByQueries = async (req: Request, res: Response): Promise<void> => {
...
export const getFoodDetailsById = async (req: Request, res: Response): Promise<void> => {
    // Start a try-catch block for safe error handling
    try {
