...
import { getAllFoodsByQueriesService, getFoodDetailsByIdService } from '@/modules/food-database/services/food-database.service.js';
import asyncHandler from "express-async-handler";

// Controller to handle fetching a list of all available meals
export const getAllFoodsByQueries = asyncHandler(async (req: Request, res: Response): Promise<void> => {
                ...
                const meals = await getAllFoodsByQueriesService(name || "", userId);
...
export const getFoodDetailsById = asyncHandler(async (req: Request, res: Response): Promise<void> => {
                ...
                const meal = await getFoodDetailsByIdService(parseInt(mealId));
