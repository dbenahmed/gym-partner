import * as exerciseSearchRepo from "@/modules/exercise-search/repositories/exercise-search.repository.js";
...
export const searchExercisesByQueriesService = async (queries: GetExercisesQueries, page: number, limit: number) => {
