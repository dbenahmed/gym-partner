...
export const getUserWorkoutCollections = async (req: Request, res: Response): Promise<void> => {
...
export const getWorkoutRoutinesForCollection = async (req: Request, res: Response): Promise<void> => {
    // Wrap the logic in a try-catch block for safe error handling
    try {
        // Extract the userId from the authenticated request object and typecast it to a number
        const userId = req.user as number;
...
export const createWorkoutRoutine = async (req: Request, res: Response): Promise<void> => {
    // Wrap the logic in a try-catch block for safe error handling
    try {
        // Extract the userId from the authenticated request object and typecast it to a number
        const userId = req.user as number;
...
export const getWorkoutRoutineDetails = async (req: Request, res: Response): Promise<void> => {
    // Wrap the logic in a try-catch block for safe error handling
    try {
...
export const updateWorkoutRoutine = async (req: Request, res: Response): Promise<void> => {
    // Wrap the logic in a try-catch block for safe error handling
    try {
        // Extract the userId from the authenticated request object and typecast it to a number
        const userId = req.user as number;
...
export const deleteWorkoutRoutine = async (req: Request, res: Response): Promise<void> => {
    // Wrap the logic in a try-catch block for safe error handling
    try {
        // Extract the userId from the authenticated request object and typecast it to a number
        const userId = req.user as number;
...
export const updateExerciseInRoutine = async (req: Request, res: Response): Promise<void> => {
    // Wrap the logic in a try-catch block for safe error handling
    try {
        // Returning a 501 Not Implemented status as this endpoint lacks implementation in original
        res.status(501).json({ message: 'Not implemented' });
...
export const removeExerciseFromRoutine = async (req: Request, res: Response): Promise<void> => {
    // Wrap the logic in a try-catch block for safe error handling
    try {
        // Extract the userId from the authenticated request object and typecast it to a number
        const userId = req.user as number;
...
export const getExercisesForRoutine = async (req: Request, res: Response): Promise<void> => {
    // Wrap the logic in a try-catch block for safe error handling
    try {
        // Extract the userId from the authenticated request object and typecast it to a number
        const userId = req.user as number;
