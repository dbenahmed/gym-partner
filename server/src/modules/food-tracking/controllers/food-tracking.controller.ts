...
export const getUserFoodsByDate = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const logUserFoodForDate = async (req: Request, res: Response): Promise<void> => {
    try {
        const userId = req.user;
...
export const updateUserLoggedFood = async (req: Request, res: Response): Promise<void> => {
    try {
...
export const deleteUserLoggedFood = async (req: Request, res: Response): Promise<void> => {
    try {
        const userId = req.user;
        const { mealId } = req.params;
