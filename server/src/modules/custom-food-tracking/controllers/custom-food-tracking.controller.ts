...
export const createUserCustomFood = async (req: Request, res: Response) => {
    try {
...
export const getAllUserCustomFoods = async (req: Request, res: Response) => {
    try {
        const userId = req.user as number;
...
export const deleteUserCustomFood = async (req: Request, res: Response) => {
    try {
