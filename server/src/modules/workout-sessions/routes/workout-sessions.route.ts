...
import { createWorkoutSession, getUserWorkoutSessionsByDate, getWorkoutSessionDetails, saveExerciseToSession, logSetForExercise, updateWorkoutSession, deleteWorkoutSession } from '@/modules/workout-sessions/controllers/workout-sessions.controller.js';
...
router.get('/workout/sessions', authMiddleware, getUserWorkoutSessionsByDate);
