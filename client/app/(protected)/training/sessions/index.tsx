      ...
      <View style={{ flex: 1, backgroundColor: colors.background }}>
         ...
         {loading ? (
            ...
            <FlatList
               ...
               }} // Added marginBottom to avoid overlap with button
               ...
               renderItem={({ item }) => (
                  <TouchableOpacity
                     ...
                     onPress={() => {
                        ...
                        router.push({
                           pathname: `${String(routesLink.PROTECTED_SESSION_DETAILS).replace(':sessionId', item.id)}` as any,
                        });
                     }}
                  >
         ...
         <Button
            ...
            onClick={() => {
               router.push({
                  pathname: `${routesLink.PROTECTED_NEW_SESSION}` as any,
               });
            }}
            type="primary"
            icon="plus"
