...
import { validateUsername, validateName } from "@/utils/validation";

import { PageButton, EditProfileModal, fetchUserProfile, fetchUpdateProfile } from "@/features/profile";

export default function Profile() {
  const { colors, theme, toggleTheme, deviceTheme } = useThemeContext();

  const handleThemeChange = (theTheme: any) => {
        ...
        <View style={styles.profileCard}>
          ...
          >
            ...
            <PageButton icon="scale-bathroom" title={"Track Body Weight"} onPress={() => {
              router.push({
                pathname: `${routesLinks.PROTECTED_PROFILE_BODY_WEIGHT_TRACKING}` as any,
              });
            }} />
          </ScrollView>
          <View>
