...
interface ButtonProps {
    ...
    text?: string;
    icon?: any;
    type?: 'primary' | 'secondary' | 'outline' | 'tertiary' | 'disabled';
    disabled?: boolean;
    iconSize?: number;
}

export default function Button({ children = null, styles = {}, onClick, text, icon = undefined, type = 'primary', disabled = false, iconSize = 20 }: ButtonProps) {
