          ...
          <ScrollView style={styles.filterScrollView} keyboardShouldPersistTaps="handled">
            <View style={styles.filterSection}>
              ...
              <ButtonGroup
                ...
                onSelect={(val) => handleSelect("force", val)}
              />
            </View>
            ...
            <View style={styles.filterSection}>
              ...
              <ButtonGroup
                ...
                onSelect={(val) => handleSelect("mechanic", val)}
              />
            </View>
            ...
            <View style={styles.filterSection}>
              ...
              <ButtonGroup
                ...
                onSelect={(val) => handleSelect("equipment", val)}
              />
            </View>
            ...
            <View style={styles.filterSection}>
              ...
              <ButtonGroup
                ...
                onSelect={(val) => handleSelect("primaryMuscle", val)}
              />
            </View>
            ...
            <View style={styles.filterSection}>
              ...
              <ButtonGroup
                ...
                onSelect={(val) => handleSelect("secondaryMuscle", val)}
              />
            </View>
